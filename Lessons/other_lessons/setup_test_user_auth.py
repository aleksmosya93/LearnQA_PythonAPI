...
class TestUserAuth:
    ...
    def setup(self):
        ...
        assert "auth_sid" in response1.cookies, "There id no auth cookie in the response"
    ...
    def test_negativ_auth_check(self, condition):
        ...
        assert user_id_from_check_method == 0, f"User is authorizes with condition {condition}"
