import pytest
from Lessons.lib.my_requests import MyRequests
from Lessons.lib.base_case import BaseCase
from Lessons.lib.assertions import Assertions
import allure
...
class TestUserAuth(BaseCase):
    ...
    def test_negativ_auth_check(self, condition):
        ...
        Assertions.assert_json_value_by_name(
            ...
            "user_id",
            0,
            f"User is authorizes with condition {condition}"
        )
